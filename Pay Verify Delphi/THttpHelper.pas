...
{ THttpClient }
constructor THttpHelper.Create(RLocalPort: Word);
begin
...
function THttpHelper.GetErrMsg: AnsiString;
begin
...
function THttpHelper.GetResponse: AnsiString;
begin
...
procedure THttpHelper.OnSockError(RSender: TObject; RSocketErr: Integer);
begin
  FHaveErr := True;
